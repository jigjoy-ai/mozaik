...
import { claudeSonnet46Specification } from "src/runtime/infrastructure/providers/anthropic/models/claude-4-6-sonnet"
import { claudeOpus48Specification } from "src/runtime/infrastructure/providers/anthropic/models/claude-4-8-opus"
import { claudeOpus47Specification } from "src/runtime/infrastructure/providers/anthropic/models/claude-4-7-opus"
import { gemini35FlashSpecification } from "src/runtime/infrastructure/providers/gemini/models/gemini-3-5-flash"
import { gemini31ProSpecification } from "src/runtime/infrastructure/providers/gemini/models/gemini-3-1-pro"
import { deepSeekV4FlashSpecification } from "src/runtime/infrastructure/providers/deepseek/models/deepseek-v4-flash"
import { deepSeekV4ProSpecification } from "src/runtime/infrastructure/providers/deepseek/models/deepseek-v4-pro"
import { gpt54Specification } from "src/runtime/infrastructure/providers/openai/models/gpt-5-4"
import { gpt54MiniSpecification } from "src/runtime/infrastructure/providers/openai/models/gpt-5-4-mini"
